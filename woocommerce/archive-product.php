				...
				<div class="<?= bootscore_main_col_class(); ?> px-0">
					...
					<div class="entry-content">
						...
						<div class="nav nav-tabs orderby custom-select d-flex justify-content-end" id="nav-tab" role="tablist" >
							<button class="nav-link btn-tabs-list active px-2" id="nav-grid-tab"  data-bs-toggle="tab" data-bs-target="#nav-grid-home" type="button" role="tab" aria-controls="nav-grid-home" aria-selected="false" tabindex="-1">
							...
							<button class="nav-link btn-tabs-list px-2" id="nav-line-tab"  data-bs-toggle="tab" data-bs-target="#nav-line-home" type="button" role="tab" aria-controls="nav-line-home" aria-selected="false" tabindex="-1" >
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
