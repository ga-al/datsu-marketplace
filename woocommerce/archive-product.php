			...
			<div class="row px-2">
				<div class="<?= bootscore_main_col_class(); ?> px-0">
					...
					<div class="entry-content">
						<h1 class="display-5 text-primary fw-bold lh-1 mt-md-0 mb-md-2 my-4"><?php woocommerce_page_title(); ?></h1>
						<?php woocommerce_breadcrumb()?>

						<div class="nav nav-tabs orderby custom-select d-flex justify-content-end" id="nav-tab" role="tablist" >
							<button class="nav-link btn-tabs-list active px-1" id="nav-grid-tab"  data-bs-toggle="tab" data-bs-target="#nav-grid-home" type="button" role="tab" aria-controls="nav-grid-home" aria-selected="false" tabindex="-1">
						...
						<div class="tab-content pt-4" id="nav-tabContent">
							...
							<div class="tab-pane fade active show" id="nav-grid-home" role="tabpanel" aria-labelledby="nav-grid-tab">
							<!-- Loop Products Category -->
								<?php
