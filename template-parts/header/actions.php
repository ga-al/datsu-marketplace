...
<?php if (is_active_sidebar('top-nav-search')) : ?>
  <button class="btn btn-primary d-lg-none ms-1 ms-md-2 top-nav-search-md" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-search" aria-expanded="false" aria-controls="collapse-search">
