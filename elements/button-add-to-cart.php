...
<a href="?add-to-cart=<?php echo $product_id; ?>" class="<?php echo $classes?> d-inline-block add_to_cart_button ajax_add_to_cart btn-order" product-title="<?php echo $product_name; ?>" data-product_id="<?php echo $product_id; ?>" data-product_sku="<?php echo $product_sku; ?>">
